...
At the bottom of your routes.rb, we need to set up the root route to go to the home page defined in the system.  Make sure the bottom of you file looks like this:
